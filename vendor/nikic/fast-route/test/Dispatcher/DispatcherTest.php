...
abstract class DispatcherTest extends TestCase
{
     ...
     */
    public function test_found_dispatches($method, $uri, $callback, $handler, $argDict)
    {
     ...
     */
    public function test_not_found_dispatches($method, $uri, $callback)
    {
        $dispatcher = \FastRoute\simpleDispatcher($callback, $this->generateDispatcherOptions());
     ...
     */
    public function test_method_not_allowed_dispatches($method, $uri, $callback, $availableMethods)
    {
        $dispatcher = \FastRoute\simpleDispatcher($callback, $this->generateDispatcherOptions());
        $routeInfo = $dispatcher->dispatch($method, $uri);
     ...
     */
    public function test_duplicate_variable_name_error()
    {
     ...
     */
    public function test_duplicate_variable_route()
    {
        \FastRoute\simpleDispatcher(function (RouteCollector $r) {
     ...
     * @expectedExceptionMessage Cannot register two routes matching "/user" for method "GET"
     */
    public function test_duplicate_static_route()
    {
        \FastRoute\simpleDispatcher(function (RouteCollector $r) {
     ...
     */
    public function test_shadowed_static_route()
    {
        \FastRoute\simpleDispatcher(function (RouteCollector $r) {
